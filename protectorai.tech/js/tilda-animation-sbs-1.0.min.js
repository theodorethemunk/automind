...
function t_animationSBS__init() {
    ...
    /Bot/i.test(navigator.userAgent) || document.documentMode < 11 || e || (document.querySelector('[data-animate-sbs-event="scroll"]') && (t.style.overflowX = "hidden"), t_animationSBS__isZeroBlocksRendered(function() {
...
function t_animationSBS__isZeroBlocksRendered(e) {
    var n, i, a = t_animationSBS__getArtboards("396");
    (a = a.length ? a : t_animationSBS__getArtboards("121")).length && (n = !1, a.every(function(t) {
        return t.classList.contains("rendered")
    }) ? e() : document.querySelectorAll('script[src*="tilda-blocks-2"], script[src*="tilda-blocks-1"]').length ? t_animationSBS__backwardCompatibilityWait(a, Date.now(), e) : (i = a.filter(function(t) {
        return t.classList.contains("rendered")
    }), a.forEach(function(t) {
        t.classList.contains("rendered") || t.addEventListener("artBoardRendered", function() {
...
function t_animationSBS__backwardCompatibilityWait(t, e, n) {
    t.every(function(t) {
        return t.classList.contains("rendered")
    }) ? n() : 1e4 < Date.now() - e ? console.warn("all zero-blocks can't be rendered") : setTimeout(function() {
...
function t_animationSBS_isInstagramRendered(t) {
    var e;
    window.animationSBS__isIOS && -1 !== navigator.userAgent.indexOf("Instagram") ? e = setTimeout(function() {
...
function t_animationSBS__wrapAndUpdateEls(t) {
    var l = -1 !== navigator.userAgent.indexOf("Chrome");
    t.forEach(function(t) {
        var e, n, i, a, r, o, s = t.querySelector(".tn-molecule, .tn-atom");
        s && (e = ".tn-atom__sbs-anim-wrapper:not(.tn-molecule__sbs-anim-wrapper)", n = ["tn-atom__sbs-anim-wrapper"], (r = s.classList.contains("tn-molecule")) && (e = ".tn-molecule__sbs-anim-wrapper", n.push("tn-molecule__sbs-anim-wrapper")), -1 === navigator.userAgent.indexOf("Chrome") && (s.style.WebkitBackfaceVisibility = "hidden", s.style.backfaceVisibility = "hidden"), i = s.closest(e), a = t_animationSBS__getAnimOptions(t, "published", null), !i && a && (r && (s.style.display = "inherit"), a = s.closest(".tn-atom__scale-wrapper"), (r = t.style.transform) && -1 !== r.indexOf("matrix(") && (t_animationSBS__wrapEl(a || s, "tn-atom__sbs-transform-wrapper"), (o = t.querySelector(".tn-atom__sbs-transform-wrapper")).style.transform = r, t.style.transform = ""), t_animationSBS__wrapEl((o = t.querySelector(".tn-atom__sbs-transform-wrapper")) || a || s, n), i = (s = t.querySelector(".tn-molecule, .tn-atom")).closest(e), t_animationSBS__updateStylesAfterWrapping(t, o || i, l)))
    })
}
...
function t_animationSBS__wrapAndUpdateElOnResize(t) {
    ...
    })).length && t_animationSBS__wrapAndUpdateEls(t)
}
...
function t_animationSBS__updateStylesAfterWrapping(e, n, i) {
    var a = e.getAttribute("data-elem-type"),
        ...
        t = ("shape" !== a && "button" !== a && "image" !== a || !parseInt(t, 10) || (n.style.borderRadius = t), ["filter", "backdrop-filter"]),
        o = (t = (t = t.map(function(t) {
            var e = "-webkit-" + t,
                n = r.getPropertyValue(t);
            if ("none" !== (n = "none" !== n && "" !== n ? n : r.getPropertyValue(e)) && "" !== n) return {
                filter: t,
                webkitFilter: e,
                value: n
            }
...
function t_animationSBS__chromeFixBackdropFilter(t, e) {
    ...
    "rgba(0, 0, 0, 0)" !== i && "1" !== a && (i = i.substring(i.indexOf("(") + 1, i.indexOf(")")), (n = t_animationSBS__processBoxShadowRGB(n, a)) && (e.style.boxShadow = n, t.style.boxShadow = "none"), e.style.backgroundColor = "rgba(" + i + "," + a + ")", t.style.opacity = "1", t.style.backgroundColor = "transparent", t.style.backdropFilter = "initial", t.style.WebkitBackdropFilter = "initial")
}
...
function t_animationSBS__initAllRes(t) {
    ...
    function r() {
        clearTimeout(n), n = setTimeout(function() {
            ...
            t_animationSBS__updateAnimatedObjectState(a, "elements", t), t_animationSBS__wrapAndUpdateElOnResize(a.elements), t_animationSBS__cacheAndSetData(a), t_animationSBS__triggerScrollAnim(a), e = t_animationSBS__getAnimElsOnView(a.elements), t_animationSBS__triggerNoScrollAnimation(a, e), t_animationSBS__generateKeyframes(a)
        }, 500)
    }
    a.elements.length && (t_animationSBS__cacheAndSetData(a), t_animationSBS__generateKeyframes(a), t = !!(t = document.getElementById("allrecords")) && "yes" === t.getAttribute("data-tilda-lazy"), "y" !== window.lazy && !t || t_onFuncLoad("t_lazyload_update", function() {
        t_lazyload_update()
    }), e = t_animationSBS__getAnimElsOnView(a.elements), t = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), "ResizeObserver" in window ? t_animationSBS__createResizeObserver({
        breakpoints: i = t_animationSBS__getAllBreakpoints(),
        currentRes: t_animationSBS__getCurrentRes(i, t),
        isMobile: t
    }, r) : t ? window.addEventListener("orientationchange", function() {
        setTimeout(function() {
            r()
        }, 300)
    }) : window.addEventListener("resize", r), i = document.querySelectorAll(".t396"), Array.prototype.forEach.call(i, function(t) {
        t.addEventListener("displayChanged", r)
    }), window.t_animationSBS__isSafari && window.addEventListener("scroll", function t() {
        0 !== window.pageYOffset && r();
        window.removeEventListener("scroll", t)
    }), t_animationSBS__triggerNoScrollAnimation(a, e), document.querySelectorAll('[data-animate-sbs-event="scroll"]').length && (t_animationSBS__triggerScrollAnim(a), t_animationSBS__checkFrame(a)), window.addEventListener("load", function() {
...
function t_animationSBS__triggerScrollAnim(n) {
    n.elements.forEach(function(t) {
        var e;
        "scroll" === t.animType && (t_animationSBS__scrollAnimationCheckSteps(n, t, e = {
            opacity: 1,
            blur: 0,
            fix: !1,
            fixedShiftY: 0,
...
function t_animationSBS__scrollAnimationCheckSteps(s, l, _) {
    ...
    }), l.classList.remove("t396__elem--anim-hidden"), l.steps[1] && 0 === l.steps[1].dist && 0 === l.steps[1].styles.opacity && "unactive" === l.steps[1].state && (_.opacity = 0)
}
...
function t_animationSBS__scrollAnimationUpdateTransform(t, e) {
    var n, i, a;
    t.wrapperEl && (n = t_animationSBS__getZoom(t), a = getComputedStyle(t).willChange, window.t_animationSBS__isOnlyScalable && (n = 1 / n), !0 === e.fix && "fixed" !== t.wrapperEl.style.position && (i = t.triggerOffset - e.prevUnfixedDist, window.t_animationSBS__isOnlyScalable || (i /= n), t.scaledDifference && (i += t.scaledDifference), t.wrapperEl.style.top = i + "px", t.wrapperEl.style.position = "fixed", a && "auto" !== a && (t.style.willChange = "unset"), t.zIndex && (t.wrapperEl.style.zIndex = t.zIndex)), !1 === e.fix && "fixed" === t.wrapperEl.style.position && (t.wrapperEl.style.position = "", t.wrapperEl.style.top = "", t.wrapperEl.style.zIndex = "", t.zIndex && (t.style.zIndex = t.zIndex), t.style.willChange = ""), t.wrapperEl.style.opacity = e.opacity.toString(), i = "", e.translateX && (a = e.translateX, window.t_animationSBS__isOnlyScalable && (a /= n), i += "translateX(" + a + "px)"), 0 === e.translateY && 0 === e.fixedShiftY || (a = e.translateY + e.fixedShiftY, window.t_animationSBS__isOnlyScalable || (a /= n), i += "translateY(" + a + "px)"), 1 === e.scaleX && 1 === e.scaleY || (i += "scale(" + e.scaleX + "," + e.scaleY + ")"), 0 !== e.rotate && (i += "rotate(" + e.rotate + "deg)"), t.wrapperEl.style.transform = i || "scale(1)")
}
...
function t_animationSBS__generateKeyframes__correctFrames(s) {
    s.forEach(function(t, e) {
        var n, i = e === s.length - 1,
            a = 0 === e,
            r = i ? null : s[e + 1],
            o = a ? null : s[e - 1];
        for (n in t.styles) a || n in o.styles || t_animationSBS__generateKeyframes__addStyleToKeyframe(t, o, n, 0), i || (n in r.styles ? "moveX" !== n && "moveY" !== n && "rotate" !== n || t_animationSBS__generateKeyframes__recalculateValue(t, r, n) : t_animationSBS__generateKeyframes__addStyleToKeyframe(t, r, n, 1))
    })
}
...
function t_animationSBS__generateKeyframes__getReverseAnim(t) {
    var e = t.classList.contains("tn-group"),
        ...
        n = "";
    return (n += "#" + (t.closest(".t-rec") ? t.closest(".t-rec").getAttribute("id") : "") + " ") + (e + ".t-sbs-anim_started.t-sbs-anim_reversed .tn-atom__sbs-anim-wrapper ") + "{\n-webkit-animation-direction: reverse;\nanimation-direction: reverse;\n}\n\n"
}
...
function t_animationSBS__getAnimOptions(e, t, n) {
    ...
    var i = t_animationSBS__generateAttr(a, n, r, o.res),
        l = e.getAttribute(i);
    return l || (o.breakpoints.forEach(function(t) {
...
function t_animationSBS__getResOpts(t) {
    var e, n;
    if (!window.tn) return n = window.innerWidth, [1200, 960, 640, 480, 320].forEach(function(t) {
        e || t <= n && (e = t)
    }), {
        res: e || 320,
        resMax: 1200,
...
function t_animationSBS__generateUniqueIDForEl(t) {
    var e = t.closest(".t396__artboard, .tn-artboard"),
        n = "",
        e = (e && (n = e.getAttribute("data-record-id") || e.getAttribute("data-artboard-recid")), t.getAttribute("data-elem-id") || t.getAttribute("data-group-id"));
...
function t_animationSBS__setAndCacheElTopPos(e, t) {
    var n, i = t_animationSBS__getZoom(e),
        a = ["scroll", "intoview", "blockintoview"].every(function(t) {
            return e.animType !== t
        });
    t.isEditMode || a || (t = parseInt(e.style.top, 10), (a = e.closest(".t396__group")) && a !== e && (t += parseInt(a.style.top, 10) || 0), "scroll" !== e.animType && "intoview" !== e.animType || window.t_animationSBS__isOnlyScalable || (t *= i), n = (a = e.closest(".r")) ? a.getBoundingClientRect().top + window.pageYOffset : 0, a = a && parseInt(a.style.paddingTop, 10) || 0, e.parentRecTopPos = n, e.topOffset = n + t + a, t_animationSBS__setScaledDifference(e, i), t_animationSBS__setTriggerOffset(e))
}

function t_animationSBS__setScaledDifference(t, e) {
    var n;
    !t.scaledDifference && window.t_animationSBS__isOnlyScalable && "fixed" !== t.wrapperEl.style.position && (n = t.wrapperEl ? t.wrapperEl.getBoundingClientRect().height : 0, e = Math.abs((n * e - n) / 2), e = Math.round(e), t.scaledDifference = e)
}
...
function t_animationSBS__removeHoverClickTriggers(t) {
    ...
    e.length && ((e = Array.prototype.slice.call(e)).forEach(function(e) {
...
function t_animationSBS__initClickTriggers(t) {
    var e, n = t.elements.filter(function(t) {
        return "click" === t.getAttribute("data-animate-sbs-event")
    });
    n.length && (t_animationSBS__connectTriggersWithAnimEls(n), (n = Array.prototype.slice.call(document.querySelectorAll(".js-sbs-anim-trigger_click"))).length && (document.getElementById("js-sbs-anim-trigger-styles") || ((e = document.createElement("style")).id = "js-sbs-anim-trigger-styles", e.textContent = ".js-sbs-anim-trigger_click { cursor: pointer; }", document.head.insertAdjacentElement("beforeend", e)), (t.clickedTriggerEls = n).forEach(function(t) {
...
function t_animationSBS__initClickCallback() {
    ...
    (t && t.length || e && e.length) && (t_animationSBS__playOnceAnimation(this, e, "click"), t && t.length && ((e = t[0]) && e.classList.contains("t-sbs-anim_started") && !e.classList.contains("t-sbs-anim_reversed") ? t_animationSBS__actionOnEnd : t_animationSBS__actionOnStart)(t))
}

function t_animationSBS__playOnceAnimation(t, e, n) {
    var i;
    e && e.length && (t_animationSBS__actionOnStart(e), (i = document.createEvent("Event")).initEvent("updateAnimOnce", !0, !0), e.forEach(function(t) {
        t.dispatchEvent(i)
...
function t_animationSBS__initHoverTriggers(t) {
    ...
    e.length && (t_animationSBS__connectTriggersWithAnimEls(e), e = document.querySelectorAll(".js-sbs-anim-trigger_hover"), e = Array.prototype.slice.call(e), (t.hoverTriggerEls = e).forEach(function(t) {
...
function t_animationSBS__preventAnimatedParentTrigger(t) {
    var e;
    "none" !== getComputedStyle(t).pointerEvents && (e = t.querySelector(".tn-molecule, .tn-atom"), t.style.pointerEvents = "none", e.style.pointerEvents = "auto")
}
...
function t_animationSBS__connectTriggersWithAnimEls(t) {
    ...
    t.forEach(function(e) {
        var t, n, i = e.triggerElems;
        i ? (i = i ? i.split(",") : [], t = e.closest(".t396__artboard"), n = t ? t.getAttribute("data-artboard-recid") : "", i.forEach(function(t) {
            t = n + t;
            t_animationSBS__processTriggersElemList(document.querySelector(".tn-elem__" + t + ", .tn-group__" + t), e, a)
...
function t_animationSBS__getAnimationFullTime(t, n) {
    return t.getAttribute("data-animate-sbs-opts") ? JSON.parse(t.getAttribute("data-animate-sbs-opts").split("'").join('"')).reduce(function(t, e) {
...
function t_animationSBS__playAnimation(e, t) {
    ...
    t && i.push("t-sbs-anim_reversed"), 0 < n && i.push("t-sbs-anim_playing"), i.forEach(function(t) {
        e.classList.add(t)
...
function t_animationSBS__getZoom(t) {
    ...
    return t.classList.contains("t396__artboard_scale") || !window.animationSBS__isOldPage && "undefined" != typeof t396_ab__getFieldValue && "window" === t396_ab__getFieldValue(t, "upscale") ? e && window.tn["ab" + e] && window.tn["ab" + e].scaleFactor || window.tn_scale_factor : 1
}

function t_animateSbs__wrapAtomEls() {
    var t = document.querySelectorAll("[data-animate-sbs-event]");
    Array.prototype.forEach.call(t, function(t) {
        var e, n = t.querySelector(".tn-atom");
        n && !n.closest(".tn-atom__sbs-anim-wrapper") && (t_animationSBS__wrapEl(n, "tn-atom__sbs-anim-wrapper"), n = t.getAttribute("data-elem-type"), e = window.getComputedStyle(t).getPropertyValue("border-radius"), "shape" === n && e && parseInt(e) && ((n = t.querySelector(".tn-atom__sbs-anim-wrapper")) && (n.style.borderRadius = e)))
    })
}

function t_animateSbs__cashElsInfo(o) {
    var t = o.els;
    o.triggerElemsAttrName = "edit" === o.mode ? "data-field-sbstrgels-value" : "data-animate-sbs-trgels", Array.prototype.forEach.call(t, function(t) {
        if (t.state = "unactive", t.animType = "edit" === o.mode ? t.getAttribute("data-field-sbsevent-value") : t.getAttribute("data-animate-sbs-event"), t.changeType = "scroll" === t.animType ? "scroll" : "time", t.trigger = "edit" === o.mode ? t.getAttribute("data-field-sbstrg-value") : t.getAttribute("data-animate-sbs-trg"), t.trigger = t.trigger || 1, t.triggerElems = t.getAttribute(o.triggerElemsAttrName), t.wrapperEl = t.querySelector(".tn-atom__sbs-anim-wrapper"), t.steps = [], e = "edit" === o.mode ? t.getAttribute("data-field-sbsopts-value") : t.getAttribute("data-animate-sbs-opts")) {
            -1 !== e.indexOf("fixed") && (t.zIndex = window.getComputedStyle(t).getPropertyValue("z-index"));
            for (var e = e.replace(/'/g, '"'), n = JSON.parse(e), i = (t_animationSBS__addDelayToSteps(n), t.loop = "edit" === o.mode ? t.getAttribute("data-field-sbsloop-value") : t.getAttribute("data-animate-sbs-loop"), t_animationSBS__setAndCacheElTopPos(t, o), 0), a = 0; a < n.length; a++) {
                var r = {
                    state: "unactive"
                };
                r.styles = t_animationSBS__createStepStyles(n[a]), "scroll" === t.changeType ? (r.prevUnfixedDist = i, r.dist = n[a].di, !1 === r.styles.fix && (i += Number(r.dist)), r.start = 0 === a ? t.topOffset : t.steps[a - 1].end, r.end = r.start + +r.dist) : (r.time = n[a].ti, r.ease = n[a].ea), t.steps.push(r)
            }
...
function t_animateSbs__reset(t) {
    for (var e = t.els, n = 0; n < e.length; n++) {
        var i = e[n].animType;
        "intoview" === i || "blockintoview" === i || "click" === i || "hover" === i ? (e[n].classList.remove("t-sbs-anim_started"), (i = e[n].querySelector(".tn-atom__sbs-anim-wrapper")) && (i.style.opacity = "")) : (e[n].state = "reseted", (i = e[n].wrapperEl) && (i.style.transform = "", i.style.position = "", i.style.top = "", i.style.opacity = ""))
    }
}
...
function t_animationSBS__wrapEl(t, e) {
    ...
    "string" == typeof e ? i.classList.add(e) : e.forEach(function(t) {
        i.classList.add(t)
    }), i.style.display = "table", i.style.width = "inherit", i.style.height = "inherit", i.appendChild(t), n && n.appendChild(i)
}
window.t_animationSBS__isFirefox = -1 !== navigator.userAgent.search("Firefox"), window.t_animationSBS__isOnlyScalable = Boolean(window.t_animationSBS__isFirefox || Boolean(window.opr && window.opr.addons || window.opera || -1 !== navigator.userAgent.indexOf(" OPR/"))), window.t_animationSBS__isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), window.animationSBS__isIOS = /iPhone|iPad|iPod/i.test(navigator.userAgent) || "ontouchend" in document && /Macintosh/.test(navigator.userAgent), window.animationSBS__isOldPage = Boolean(document.querySelector('script[src*="tilda-blocks-2.7"]')), "visible" === document.visibilityState ? "loading" !== document.readyState ? t_animationSBS__init() : document.addEventListener("DOMContentLoaded", t_animationSBS__init) : document.addEventListener("visibilitychange", t_animationSBS__checkVisibilityPage);