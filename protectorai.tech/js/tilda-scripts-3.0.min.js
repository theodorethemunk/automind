    ...
    return o = o || 250,
        function() {
            var t = a || this,
                e = +new Date,
                n = arguments;
            r && e < r + o ? (clearTimeout(l), l = setTimeout(function() {
                r = e, i.apply(t, n)
            }, o)) : (r = e, i.apply(t, n))
        }
}
...
function t_onFuncLoad(n, i, o) {
    var a, r;
    "function" == typeof window[n] || "object" == typeof window[n] ? i() : (a = Date.now(), r = new Error(n + " is undefined"), setTimeout(function t() {
        var e = Date.now();
...
function t_scrollBarWidthCompensator__setObject() {
    ...
    var a = window.scrollBarWidthCompensator,
        t = (a.isInited = !1, a.scrollBarWidth = Math.abs(window.innerWidth - document.documentElement.clientWidth), a.delay = 0, a.cancelTimeout = null, ["t450", "t282__container", "t282__container__bg_opened", "t282__menu__container", "t830m", "t830__panel", "t451m", "t204__menu"]),
        e = document.querySelectorAll("*"),
        e = Array.prototype.filter.call(e, function(e) {
            return !e.closest(".t1093") && !t.some(function(t) {
                return e.classList.contains(t)
            })
        });
    a.fixedElements = [], Array.prototype.forEach.call(e, function(t) {
        var e, n, i, o;
...
window.isSearchBot = !1, /Bot/i.test(navigator.userAgent) && (window.isSearchBot = !0), window.isMobile = !1, window.$isMobile = !1, /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (window.isMobile = !0, window.$isMobile = !0), window.isTablet = /(ipad|tablet|(android(?!.*mobile))|(windows(?!.*phone)(.*touch))|kindle|playbook|silk|(puffin(?!.*(IP|AP|WP))))/i.test(navigator.userAgent), window.isiOS = !1, /iPhone|iPad|iPod/i.test(navigator.userAgent) && (window.isiOS = !0), window.isiOSChrome = !!navigator.userAgent.match("CriOS"), window.isFirefox = /firefox/i.test(navigator.userAgent), window.isOpera = !!window.opr && !!window.opr.addons || !!window.opera || 0 <= navigator.userAgent.indexOf(" OPR/"), window.isiOSVersion = "", window.isiOS && null !== (version = navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/)) && (window.isiOSVersion = [parseInt(version[1], 10), parseInt(version[2], 10), parseInt(version[3] || 0, 10)]), window.isSafari = !1, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && (window.isSafari = !0), window.isIE = !!document.documentMode, window.isSafariVersion = "", window.isSafari && null !== (version = navigator.appVersion.match(/Version\/(\d+)\.(\d+)\.?(\d+)? Safari/)) && (window.isSafariVersion = [parseInt(version[1], 10), parseInt(version[2], 10), parseInt(version[3] || 0, 10)]), window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang, t_onReady(function() {
        ...
        if (!window.isMobile && t && "yes" !== t.getAttribute("data-blocks-animationoff") && !1 === window.isSearchBot) {
            ...
            for (var o, a, r, l, d = Array.prototype.slice.call(e).filter(function(t) {
                    return !t.getAttribute("data-animationappear") && !t.getAttribute("data-screen-min") && !t.getAttribute("data-screen-max")
                }), n = 0; n < d.length; n++) {
                var s, c = (s = d[n]).getBoundingClientRect().top + window.pageYOffset,
            ...
            function h() {
                for (var t = d.length - 1; 0 <= t; t--) {
                    var e = d[t];
                    e.getBoundingClientRect().top + window.pageYOffset < (e.offsetHeight <= 100 ? window.pageYOffset + window.innerHeight : window.pageYOffset + window.innerHeight - 100) && (t_removeClass(e, "r_hidden"), t_addClass(e, "r_showed"), (d = Array.prototype.slice.call(d)).splice(t, 1))
                }
            }
            d.length && (0 < (o = document.querySelectorAll('[data-record-type="400"]')).length && (r = a = 0, l = setInterval(function() {
    ...
    function() {
        ...
        function t() {
            ...
            for (var l, d, s = document.querySelectorAll("[data-height-correct-vh]"), c = window.innerHeight, r = a = 0; r < s.length; r++) - 1 < (d = (l = s[r]).style).height.indexOf("vh") && (a = parseInt(d.height) / 100, d.height = t = c + "px")
        }

        function e() {
            for (var t = h ? screen.width : window.innerWidth, e = (window.isMobile && !h && (t = document.documentElement.clientWidth), document.querySelectorAll('.r:not([data-record-type="396"]):not([data-record-type="1003"])')), n = [], i = 0; i < e.length; i++) {
                var o = e[i],
                    a = getComputedStyle(o);
                "none" !== a.display && "hidden" !== a.visibility && "0" !== a.opacity && n.push(o)
            }
            for (var r = 0; r < n.length; r++)
                for (var l = n[r], d = l.querySelectorAll('div:not([data-auto-correct-mobile-width="false"]):not(.tn-elem):not(.tn-atom):not(.tn-atom__sbs-anim-wrapper):not(.tn-atom__prx-wrapper):not(.tn-atom__videoiframe):not(.tn-atom__sticky-wrapper):not(.t-store__relevants__container):not(.t-slds__items-wrapper):not(.js-product-controls-wrapper):not(.js-product-edition-option):not(.t-product__option-variants)'), s = 0; s < d.length; s++) {
                    var c = d[s],
