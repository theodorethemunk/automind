...
function t_animate__deleteAnimatedEls(t, e) {
    ...
    return t.forEach(function(t) {
        ...
        t.curTopOffset <= a ? (t_animate__removeAnimationClass(t, ["wait", "no-hover"]), t.classList.add("t-animate_started")) : i.push(t)
    }), [i, n]
}
...
function t_animate__animateNumbers(e) {
    ...
    var a, n, i, r, o, s, l = e.getAttribute("data-animate-number-count"),
        ...
        _ = null,
        d = (l && (_ = l.match(/\d+\.\d+|\d+,\d+/g), a = l.match(/\d+/g), l.replace(/(\d)(?= \d) /g, "$1").split(" ").forEach(function(t) {
        ...
        y = (e.removeAttribute("data-animate-number-count"), null !== _ && (u = -1 !== _[0].indexOf(",")), c.forEach(function(t, e) {
            var a;
            null !== _ && (-1 !== t.indexOf(",") && (a = t.split(",")), -1 !== t.indexOf(".") && (a = t.split(".")), -1 === t.indexOf(",") && -1 === t.indexOf(".") || (d = a[1].length, c[e] = +a.join("."), f = !0))
        }), e.querySelector(".t-animate__number"));
    c[0] && (n = Number(c[0]) || 0, i = 0, r = Math.pow(10, d), f && (n *= r, i *= r), o = 0, s = setInterval(function() {
        var t;
        i += n / 108, o = f ? (Math.round(i) / r).toFixed(d) + "" : Math.floor(i) + "", 1 < a.length && (o = o.replace(/(\d)(?=(\d{3})+([^\d]|$))/g, "$1 ")), u && (o = o.replace(/\./g, ",")), y && (y.textContent = o), n <= i && (clearInterval(s), e.innerHTML = l, t = e.querySelectorAll("span"), Array.prototype.forEach.call(t, function(t) {
...
function t_animate__setAnimELemsState(t, n, i) {
    t.forEach(function(t) {
        ...
        t_animate__setCustomAnimSettings(t, e, i), e < a && !t.closest(".t1093") && (t_animate__removeNoHoverClassFromBtns(t), t.classList.add("t-animate_started"), "animatednumber" === t_animate__getAttrByResBase(t, "style") && t_animate__animateNumbers(t)), (a <= e || t.closest(".t1093")) && t.classList.add("t-animate_wait")
    })
}
