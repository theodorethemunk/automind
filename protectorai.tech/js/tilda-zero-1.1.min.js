function t396_init(t) {
    var e, i, n, o, r = document.getElementById("rec" + t),
        a = r ? r.querySelector(".t396") : null,
        l = r ? r.querySelector(".t396__artboard") : null;
    l && (t396_initTNobj(t, l), n = t396_detectResolution(t), e = document.getElementById("allrecords"), window.tn_window_width = document.documentElement.clientWidth, window.tn["ab" + t].scaleFactor = parseFloat((window.tn_window_width / n).toFixed(3)), window.tn_scale_factor = parseFloat((window.tn_window_width / n).toFixed(3)), t396_switchResolution(t, n), t396_updateTNobj(t), t396_artboard_build("", t), i = "ontouchend" in document, window.addEventListener("resize", function() {
        l.classList.add("t396_resizechange"), t396_waitForFinalEvent(function() {
            window.t396__isMobile || i ? document.documentElement.clientWidth !== window.tn_window_width && r && t396_isBlockVisible(r) && (t396_doResize(t), l.classList.remove("t396_resizechange")) : r && t396_isBlockVisible(r) && (t396_doResize(t), l.classList.remove("t396_resizechange"))
        }, 500, "resizeruniqueid" + t)
    }), window.addEventListener("orientationchange", function() {
        t396_waitForFinalEvent(function() {
            r && t396_isBlockVisible(r) && t396_doResize(t)
        }, 600, "orientationuniqueid" + t)
    }), window.addEventListener("load", function() {
        t396_allelems__renderView(l), t396_allgroups__renderView(l);
        var t = l ? window.getComputedStyle(l).getPropertyValue("overflow") : "";
        "function" == typeof t_lazyload_update && "auto" === t && l && l.addEventListener("scroll", t_throttle(function() {
            var t = e ? e.getAttribute("data-tilda-lazy") : null;
            "y" !== window.lazy && "yes" !== t || t_onFuncLoad("t_lazyload_update", function() {
                t_lazyload_update()
            })
        }, 500)), "" !== window.location.hash && "visible" === t && (l && (l.style.overflow = "hidden"), setTimeout(function() {
            l && (l.style.overflow = "visible")
        }, 1))
    ...
    }), r && a && l && "yes" === r.getAttribute("data-connect-with-tab") && a.addEventListener("displayChanged", function() {
        t396_allelems__renderView(l), t396_allgroups__renderView(l), t396_doResize(t)
    }), setTimeout(function() {
        r && r.closest("#allrecordstable") && a && l && a.addEventListener("displayChanged", function() {
            t396_allelems__renderView(l), t396_allgroups__renderView(l), t396_doResize(t)
        })
    }, 1e3), n = !!document.querySelector(".t635__textholder"), r && n && a && l && a.addEventListener("animationInited", function() {
        t396_allelems__renderView(l), t396_allgroups__renderView(l), t396_doResize(t)
    }), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && a && a.classList.add("t396_safari"), n = "window" === t396_ab__getFieldValue(l, "upscale"), o = e ? "edit" === e.getAttribute("data-tilda-mode") : null, n && !o && t_onFuncLoad("t396_scaleBlock", function() {
        t396_scaleBlock(t)
    }), o || "y" !== t396_ab__getFieldValue(l, "fixed-need-js") || t_onFuncLoad("t396__processFixedArtBoard", function() {
        t396__processFixedArtBoard(l)
    }), t396__processAbsoluteArtBoard(l), t396__processTopShift(l, t, !1))
}
...
function t396_updateTNobj(t) {
    ...
    for (var o = window.tn[e].screens.slice().reverse(), r = 0; r < o.length; r++) window.tn[e].curResolution === o[r] && (window.tn[e].canvas_min_width = o[r], window.tn[e].canvas_max_width = 0 === r ? window.tn.window_width : o[r - 1]);
...
function t396_ab__renderView(t) {
    ...
    var o, r, a = t396_ab__getFieldValue(t, "height"),
    ...
    if (_ && !i && s && (o = parseInt(a, 10) * d), a === l || o && l <= o) r = 0;
...
function t396_changeFilterOnSafari(t) {
    var e;
    !/^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (e = window.getComputedStyle(t).webkitBackdropFilter) && "none" !== e && "IntersectionObserver" in window && new IntersectionObserver(function(t, e) {
        t.forEach(function(t) {
            t.isIntersecting && (t = t.target, e.unobserve(t), t396__processBackdropFilterOnImage(t))
        })
    }).observe(t)
}
...
function t396__processBackdropFilterOnImage(t) {
    var e, i;
    t && (e = t.getAttribute("data-animate-sbs-opts"), i = t.classList.contains("t396__elem--backdrop-filter-img-wrappered"), e && i || !e ? t396__updateBackdropFilterOnImage(t) : t.addEventListener("backdropFilterImgWrappered", function() {
...
function t396__updateBackdropFilterOnImage(t) {
    var e, i, n;
    t && (e = t.querySelector("img"), i = t.querySelector(".tn-atom__sbs-anim-wrapper"), n = "", i && (t = i, n = window.getComputedStyle(t).webkitBackdropFilter || ""), t.style.webkitBackdropFilter = "none", t396_waitForUploadImg(e, function() {
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
    if (t = t396_getEl(t)) {
        var n = t.closest(".t396__artboard"),
            ...
            h = "physical" === t396_group__getFieldValue(p, "type"),
            f = (n && (g = "grid"), i = parseInt(i), t396__getCurrentScaleFactor(o));
        switch (e) {
            case "left":
                var m = "grid" === g ? "grid" : "window",
                    b = "grid" === g ? window.tn[r].grid_offset_left : 0,
                    y = "grid" === g ? window.tn[r].grid_width : window.tn.window_width;
                if ("%" === t396_elem__getFieldValue(t, "leftunits") && (i = t396_roundFloat(y * i / 100)), h) {
                    var F = parseInt(t396_group__getFieldValue(p, "left"), 10);
                    i -= F = "%" === t396_group__getFieldValue(p, "leftunits") ? t396_roundFloat(y * F / 100) : F;
                    break
                }!d && l ? "grid" === g && _ && (i *= f) : i = b + i, "center" === w && (x = t396_elem__getWidth(t), s && "window" !== m && (y *= f, x *= f), i = y / 2 - x / 2 + i), "right" === w && (x = t396_elem__getWidth(t), s && "window" !== m && (y *= f, x *= f), i = y - x + i), s && "window" !== m && (i += ((x = t396_elem__getWidth(t)) * f - x) / 2);
                break;
            case "top":
                function v(t) {
                ...
                if (m = "grid" === g ? "grid" : "window", b = "grid" === g ? parseFloat(b) : 0, y = "grid" === g ? parseFloat(y) : parseFloat(x), "%" === t396_elem__getFieldValue(t, "topunits") && (i = y * (i / 100)), h) {
                    x = parseInt(t396_group__getFieldValue(p, "top"), 10);
                    i -= x = "%" === t396_group__getFieldValue(p, "topunits") ? t396_roundFloat(y * x / 100) : x;
                    break
                }
                s && "window" !== m && (i *= f), i = (b = u && "window" !== m ? "stretch" === a ? 0 : b / f : b) + i;
                var A, V, x = t396_ab__getFieldValue(F, "height_vh"),
                    b = t396_ab__getFieldValue(F, "height"),
                    E = t396_ab__getHeight(F);
                l && !d && x && (A = parseInt(b, 10) * f), "center" === c && (V = v(t), s && "window" !== m && ("stretch" !== a ? y *= f : y = A ? E < A ? A : E : F.clientHeight, V *= f), d || !l || _ || "window" === m || "stretch" !== a || (y = A ? E < A ? A : E : F.clientHeight, y /= f), i = y / 2 - V / 2 + i), "bottom" === c && (V = v(t), s && "window" !== m && ("stretch" !== a ? y *= f : y = A ? E < A ? A : E : F.clientHeight, V *= f), d || !l || _ || "window" === m || "stretch" !== a || (y = A ? E < A ? A : E : F.clientHeight, y /= f), i = y - V + i), s && "window" !== m && (x = ((V = v(t)) * f - V) / 2, i += x = Math.round(x))
        }
        return i
    }
}
...
function t396_group__getFieldValue(t, e) {
    if (t) {
        var i = "ab" + t.closest(".t396__artboard").getAttribute("data-artboard-recid"),
